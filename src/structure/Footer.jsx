...
function Footer() {
  return (
    <div className="">
      <div className="max-sm:fixed bottom-0 max-sm:justify-around max-sm:w-full max-sm:bg-black max-sm:bg-opacity-25 p-3 z-10 max-sm:backdrop-blur   mt-20 mx-auto w-[80%] sm:my-14 flex space-x-10 ">
        <a
